...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Nov 2025 pada 17.44
...
INSERT INTO `mobil` (`id`, `nama_mobil`, `merk_mesin`, `kecepatan_maks`, `berat_kg`) VALUES
(1, 'Red Bull RB19', 'Honda RBPT', 350, 798),
(2, 'Mercedes W14', 'Mercedes', 340, 798),
(3, 'Ferrari SF-23', 'Ferrari', 345, 798),
(4, 'McLaren MCL60', 'Mercedes', 338, 798),
(6, 'RB9000', '21313', 200, 12);
...
(10, 'Fernando Alonso', 'Alpine', 'SBrazil', 65, 0);
